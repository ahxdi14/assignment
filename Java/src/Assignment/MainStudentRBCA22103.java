...
public class MainStudentRBCA22103 {
	    public static void main(String[] args) {
	        // Creating instances of Student class
	    	StudentRBCA22103  student1 = new StudentRBCA22103 ();
	    	StudentRBCA22103  student2 = new StudentRBCA22103 ();
	    	StudentRBCA22103 student3 = new StudentRBCA22103 ();
